...
public class TaskController {
    ...
    @GetMapping("/assigne={assignee}/")
    public ResponseEntity<List<Task>> getTop10ByTaskAssignee(@PathVariable String assignee){
        return ResponseEntity.ok().body(taskService.getTop10ByTaskAssignee(assignee));
    }
    ...
    public void DeleteTaskById(@PathVariable String id) {
        this.taskService.DeleteTaskByTaskId(id);
    }
